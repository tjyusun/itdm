...
\noindent{\bfseries Website}: \href{https://tjyusun.com/MAT202}{\mono{itdm}}\par\medskip
...
\end{equation*}
By convention we define \(0! = 1\). \label{g:notation:id474034}%
\end{definition}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id474062}{}\quad{}A diagram would be useful.%
\end{inlineexercise}
\end{sectionptx}
%
%
...
\label{g:notation:id473387} A \terminology{combination} of \(k\) elements taken from a set \(S\) of size \(n\) is any \(k\)-element subset of \(S\).%
\end{definition}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id473651}{}\quad{}The first way is the usual way. For the second way: select elements that will \emph{not} be put in the \(k\)-set.%
\end{inlineexercise}
...
\begin{objectives}{Objectives}{g:objectives:id469528}
%
\begin{itemize}[label=\textbullet]
...
%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id434587}{}\quad{}Make sure the bins are in the right order!%
\end{inlineexercise}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id478952}{}\quad{}How many digits are possible?%
\end{inlineexercise}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id478930}{}\quad{}Use \hyperref[x:exercise:ex-php-last-digit]{Checkpoint~{\xreffont\ref{x:exercise:ex-php-last-digit}}}.%
\end{inlineexercise}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id479140}{}\quad{}Define pigeonholes to be the sets \(\{1,7\}\), \(\{2,6\}\), \(\{3,5\}\), \(\{4\}\), and pigeons to be the five numbers selected. Then picking five numbers from \(\{1,2,\ldots,7\}\) is the same as placing 5 pigeons into these 4 pigeonholes.%
\begin{sidebyside}{1}{0.1}{0.1}{0}%
\begin{sbspanel}{0.8}%
{\centering%
{\tabularfont%
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id479987}{}\quad{}Suppose there are \(n\) people in the group. Then each person can have \(0, 1, \ldots, \text{ or } n-1\) friends among the group. This is still \(n\) pigeonholes, so we cannot apply PHP yet.%
\par
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id268955}{}\quad{}We can apply \hyperref[x:proposition:prop-cong-division]{Proposition~{\xreffont\ref{x:proposition:prop-cong-division}}} here to divide through by 2, and we get%
\begin{equation*}
x \equiv 3 \Mod{5}\text{.}
\end{equation*}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id336331}{}\quad{}There are only 7 congruence classes to check, since we are working modulo 7.%
\end{inlineexercise}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id481956}{}\quad{}What are the numbers that satisfy the first condition? Among these, find one satisfying the second as well.%
\end{inlineexercise}
...
\par
The \terminology{cycle graph} with \(n\) vertices is denoted by \(C_n\), and is a graph that consists of a single cycle. \label{g:notation:id489692}%
\end{definition}
\begin{definition}{Complete Graph.}{x:definition:def-complete-graph}%
The \terminology{complete graph} on \(n\) vertices is denoted by \(K_n\), and is the simple graph on \(n\) vertices that consists of all possible edges between all vertex pairs. \label{g:notation:id489727}%
\end{definition}
...
\par
We call \(f\) an \terminology{isomorphism} from \(G_1\) to \(G_2\); we also say \(G_1\) is \terminology{isomorphic to} \(G_2\). \label{g:notation:id490111}%
\end{definition}
...
\end{equation*}
that is, \((u,v)\) is an edge in \(\overline{G}\) if and only if it was not an edge in \(G\). \label{g:notation:id491015}%
\end{definition}
...
\end{equation*}
That is, there is an edge in between any vertex in \(V_1\) and any vertex in \(V_2\). \label{g:notation:id492334}%
\end{definition}
...
\end{sidebyside}%
\end{divisionexercise}%
\begin{divisionexercise}{34}{}{}{g:exercise:id495396}%
The graph \(K_n\) is Hamiltonian for any \(n \geq 3\). How many different Hamiltonian cycles are contained in \(K_n\) for \(n \geq 3\)?%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id495394}{}\quad{}\(K_3\) has only one, while \(K_4\) has three, shown here.%
...
%
\typeout{************************************************}
\typeout{Appendix C List of Examples and Exercises}
\typeout{************************************************}
%
...
\hyperref[g:exercise:id462831]{Checkpoint 1.1.6}& Injective, surjective, bijective, or none?\\
\hyperref[g:exercise:id462911]{Checkpoint 1.1.9}& Prove Theorem~{\xreffont\ref*{x:theorem:thm-composition-of-bijections}}\\
\hyperref[g:exercise:id462962]{Checkpoint 1.1.11}& There are as many natural numbers as odd integers\\
\hyperref[g:exercise:id463045]{Checkpoint 1.1.13}& Cardinality of a Power Set\\
\multicolumn{2}{l}{\null}\\[1.5ex] \multicolumn{2}{l}{\large Section 1.2 Logic and Proof Techniques}\\[0.5ex]
