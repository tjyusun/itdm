...
\noindent{\bfseries Edition}: Introduction to Discrete Mathematics: Fall\slash{}Winter 2020-2021\par\medskip
...
\label{g:notation:id434430} If \(A\) and \(B\) are sets in some universe \(U\), then we say \(A\) \terminology{is a subset of} \(B\), denoted by \(A \subseteq B\), if%
\begin{equation*}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id470636}{}\quad{}You wouldn't just count them one by one\textellipsis{}%
\end{inlineexercise}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id470764}{}\quad{}To apply the Sum Rule, one needs to have a partition.%
\end{inlineexercise}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id470953}{}\quad{}Induction on \(k\).%
\end{inlineexercise}
...
\end{equation*}
By convention we define \(0! = 1\). \label{g:notation:id471098}%
\end{definition}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id471121}{}\quad{}A diagram would be useful.%
\end{inlineexercise}
%
%
\typeout{************************************************}
...
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id470437-main}\quad{}a. Listing all possibilities yields 6 ways without any restrictions:%
\begin{sidebyside}{1}{0.1}{0.1}{0}%
\begin{sbspanel}{0.8}%
{\centering%
{\tabularfont%
...
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id470618-main}\quad{}It's not a trick question. \(3 + 4 + 2 = 9\).%
\end{inlineexercisesolution}
\begin{inlineexercisesolution}{2.1.8}{Twitter Followers.}{x:exercise:ex-counting-twitter}
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id470803-main}\quad{}If all followers among TJ's three accounts are different people, then we could just add%
\begin{equation*}
...
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id470852-main}\quad{}The operation of \emph{picking an outfit to wear to school} can be broken down into the following steps:%
\begin{enumerate}
...
\pubtitle{Suśruta-saṃhitā} lxiii, as cited in \hyperlink{x:biblio:bib-kolachana-2019}{[{\xreffont 6}]}, p. 358
\end{tabular}}\\\par
\end{quote}
...
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id471928-main}\quad{}c. Treating `MATH' as a single object, we reduce the problem to counting the number of arrangements of eight distinct objects:%
...
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id461211-main}\quad{}First, we select the carry player: there are \(\displaystyle\binom{30}{1}\) ways to do so.%
\par
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id462222}{}\quad{}Stare at \hyperref[x:theorem:thm-binomial]{Theorem~{\xreffont\ref{x:theorem:thm-binomial}}} until you see it.%
\end{inlineexercise}
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id462432}{}\quad{}Count the number of lattice paths to \((k,n-k)\).%
\end{inlineexercise}
%
%
\typeout{************************************************}
...
\typeout{************************************************}
%
\begin{solutions-subsection}{Solutions to Selected Checkpoints}{}{Solutions to Selected Checkpoints}{}{}{g:solutions:id462494}
\begin{inlineexercisesolution}{2.3.7}{Coefficient of \(a^2b^3\).}{x:exercise:ex-counting-coefficient-2}
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id462174-main}\quad{}b. Take \(x = a\) and \(y = -b\) with \(n = 5\) in \hyperref[x:theorem:thm-binomial]{Theorem~{\xreffont\ref{x:theorem:thm-binomial}}}. The term \(a^2b^3\) corresponds to the index \(k = 3\), which is%
\begin{equation*}
...
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id462261-main}\quad{}The result follows from substituting \(x = 1\) and \(y = 1\) into the statement of \hyperref[x:theorem:thm-binomial]{Theorem~{\xreffont\ref{x:theorem:thm-binomial}}}.%
\end{inlineexercisesolution}
\begin{inlineexercisesolution}{2.3.10}{Lattice Paths to \((a,b)\).}{x:exercise:ex-counting-lattice-1}
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id462387-main}\quad{}The number of lattice paths to the point \((a,b)\) is the same as the number of strings of length \(a+b\) with \(a\) R's and \(b\) U's, and this is equal to%
\begin{equation*}
...
\begin{objectives}{Objectives}{g:objectives:id462518}
%
\begin{itemize}[label=\textbullet]
...
%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id460724}{}\quad{}Make sure the bins are in the right order!%
\end{inlineexercise}
...
\end{tcolorbox}%
\begin{tcolorbox}[qrstyle]%
{\hypersetup{urlcolor=black}\qrcode[height=\qrsize]{/video-7.html}}%
\end{tcolorbox}%
\end{tcbraster}%
\end{sbspanel}%
\end{sidebyside}%
...
\par\smallskip%
\noindent\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id439694}{}\quad{}Denote the scores of the students by \(x_1\), \(x_2\), and so on until \(x_{20}\).%
\par
...
\begin{objectives}{Objectives}{g:objectives:id260972}
%
\begin{itemize}[label=\textbullet]
...
\par
The \terminology{cycle graph} with \(n\) vertices is denoted by \(C_n\), and is a graph that consists of a single cycle. \label{g:notation:id337368}%
\end{definition}
\begin{definition}{Complete Graph.}{x:definition:def-complete-graph}%
The \terminology{complete graph} on \(n\) vertices is denoted by \(K_n\), and is the simple graph on \(n\) vertices that consists of all possible edges between all vertex pairs. \label{g:notation:id264762}%
\end{definition}
...
\par
We call \(f\) an \terminology{isomorphism} from \(G_1\) to \(G_2\); we also say \(G_1\) is \terminology{isomorphic to} \(G_2\). \label{g:notation:id489835}%
\end{definition}
...
\end{equation*}
that is, \((u,v)\) is an edge in \(\overline{G}\) if and only if it was not an edge in \(G\). \label{g:notation:id490541}%
\end{definition}
...
\end{equation*}
That is, there is an edge in between any vertex in \(V_1\) and any vertex in \(V_2\). \label{g:notation:id492006}%
\end{definition}
...
\end{sidebyside}%
\end{divisionexercise}%
\begin{divisionexercise}{34}{}{}{g:exercise:id493282}%
The graph \(K_n\) is Hamiltonian for any \(n \geq 3\). How many different Hamiltonian cycles are contained in \(K_n\) for \(n \geq 3\)?%
\par\smallskip%
\noindent\textbf{\blocktitlefont Hint}.\hypertarget{g:hint:id493297}{}\quad{}\(K_3\) has only one, while \(K_4\) has three, shown here.%
...
%
\typeout{************************************************}
\typeout{Section A.3 Evaluating Mathematics}
\typeout{************************************************}
%
...
%
\typeout{************************************************}
\typeout{Section A.4 Writing Mathematics}
\typeout{************************************************}
%
...
\endfoot
\endlastfoot
\(A \subseteq B\)&set inclusion&\pageref{g:notation:id434430}\\
\(\mathbb{N}\)&natural numbers&\pageref{g:notation:id485277}\\
\(\mathbb{Z}\)&integers&\pageref{g:notation:id485297}\\
\(\mathbb{Q}\)&rational numbers&\pageref{g:notation:id485271}\\
\(\mathbb{R}\)&real numbers&\pageref{g:notation:id485331}\\
\((a,b), [a,b], \text{etc.}\)&intervals of real numbers&\pageref{g:notation:id485339}\\
\(f: A \rightarrow B\)&function&\pageref{g:notation:id485343}\\
\((g \circ f)(x)\)&function composition&\pageref{g:notation:id483342}\\
\(|A| = |B|\)&cardinality, equal&\pageref{g:notation:id483473}\\
\(|A| \leq |B|\)&cardinality, less than or equal&\pageref{g:notation:id483515}\\
\(P(A)\)&power set&\pageref{g:notation:id483696}\\
\(b \mid a\)&divides; divisible by&\pageref{g:notation:id484659}\\
\(\gcd(a,b)\)&greatest common divisor&\pageref{g:notation:id484823}\\
\(n!\)&factorial&\pageref{g:notation:id471098}\\
\(P(n,k),\ {}_nP_k\)&\(k\)-permutation of an \(n\)-set&\pageref{g:notation:id471354}\\
\(\binom{n}{k}, C(n,k),\ {}_nC_k\)&\(k\)-combination of an \(n\)-set&\pageref{g:notation:id461018}\\
\(\lfloor n \rfloor\)&floor function&\pageref{g:notation:id478056}\\
\(D_n\)&number of derangements of \(\{1,2,\ldots,n\}\)&\pageref{g:notation:id465772}\\
\([x]\)&equivalence class of \(x\)&\pageref{g:notation:id442445}\\
\(a \equiv b \Mod{n}\)&congruence modulo \(n\)&\pageref{g:notation:id429961}\\
\(\mathbb{Z}_n\)&Set of congruence classes mod \(n\)&\pageref{g:notation:id430753}\\
\(a \ \mathrm{\bf mod} \ m\)&modulo operation&\pageref{g:notation:id431562}\\
\(\phi(n)\)&Euler's totient function&\pageref{g:notation:id333211}\\
\(d(v)\)&degree of a vertex&\pageref{g:notation:id246044}\\
\(V(G)\)&vertex set of \(G\)&\pageref{g:notation:id457188}\\
\(E(G)\)&edge set of \(G\)&\pageref{g:notation:id457182}\\
\(C_n\)&cycle on \(n\) vertices&\pageref{g:notation:id337368}\\
\(K_n\)&complete graph on \(n\) vertices&\pageref{g:notation:id264762}\\
\(G_1 \cong G_2\)&graph isomorphism&\pageref{g:notation:id489835}\\
\(\overline{G}\)&graph complement of \(G\)&\pageref{g:notation:id490541}\\
\(P_n\)&path graph on \(n\) vertices&\pageref{g:notation:id490705}\\
\(K_{m,n}\)&complete bipartite graph on \(m\) and \(n\) vertices&\pageref{g:notation:id492006}\\
\end{longtable}
\end{appendixptx}
%
%
...
%
\typeout{************************************************}
\typeout{Appendix E Solutions to Selected Exercises}
\typeout{************************************************}
%
\begin{solutions-chapter}{Solutions to Selected Exercises}{}{Solutions to Selected Exercises}{}{}{x:solutions:app-solutions}
\par\smallskip
...
\par\smallskip
\begin{divisionsolution}{2.7.4}{}{g:exercise:id475506}%
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id475512-back}\quad{}b. The rearrangement should start A, I, and I, in some order, and end with P, N, and N in some order. These two decisions are independent of each other, so using \hyperref[x:principle:prin-prod-rule]{Principle~{\xreffont\ref{x:principle:prin-prod-rule}}} and \hyperref[x:proposition:prop-perm-repeat]{Proposition~{\xreffont\ref{x:proposition:prop-perm-repeat}}} we count a total of%
\begin{equation*}
\dfrac{3!}{2!} \times \dfrac{3!}{2!} = 9
\end{equation*}
rearrangements. (Try listing them all!)%
\end{divisionsolution}%
\begin{divisionsolution}{2.7.8}{}{g:exercise:id475583}%
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id475690-back}\quad{}The operation of \emph{forming a straight} can be broken down into the following operations:%
\par
%
\begin{itemize}[label=\textbullet]
\item{}Pick a first card: there are 10 choices (A to 10).%
\item{}There is only one way to continue picking ranks. (If we start with a 6, then the next four cards must be 7, 8, 9, and 10.)%
\item{}Now we pick a suit for each of the cards we picked. There are four choices for each of the five cards, or a total of \(4^5\) suit combinations.%
\end{itemize}
%
\par
Hence using \hyperref[x:principle:prin-prod-rule]{Principle~{\xreffont\ref{x:principle:prin-prod-rule}}}, we can form a total of \(10 \cdot 4^5\) straights from a standard deck.%
\end{divisionsolution}%
\begin{divisionsolution}{2.7.11}{}{g:exercise:id476020}%
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id476052-back}\quad{}b. The set of three-card hands that have at least two numbered cards can be partitioned into two disjoint sets: those that have exactly two numbered cards, and those that have exactly three numbered cards. Let's call these sets \(A\) and \(B\); by \hyperref[x:principle:prin-sum-rule]{Principle~{\xreffont\ref{x:principle:prin-sum-rule}}}, the desired quantity is \(|A| + |B|\).%
\par
The hands in \(|A|\) can be counted by first selecting two numbered cards. There are 36 of them (nine ranks and four suits each) so this step has \(\binom{36}{2}\) possibilities. Then, we pick the third non-numbered card from 16 options (A, J, Q, K; four suits each). Hence by \hyperref[x:principle:prin-prod-rule]{Principle~{\xreffont\ref{x:principle:prin-prod-rule}}} \(|A| = \binom{36}{2} \cdot \binom{16}{1}\).%
\par
Also, there are \(|B| = \binom{36}{3}\) ways to pick three numbered cards. Hence the total is \(\binom{36}{2} \cdot \binom{16}{1} + \binom{36}{3}\).%
\end{divisionsolution}%
\par\smallskip
...
\par\smallskip
\begin{divisionsolution}{3.4.1}{}{g:exercise:id480265}%
\textbf{\blocktitlefont Solution}.\hypertarget{g:solution:id480331-back}\quad{}Define pigeonholes to be \(\{1,2\}\), \(\{3,4\}\), and so on.%
\end{divisionsolution}%
